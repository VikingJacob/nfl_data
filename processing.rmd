...
log_mse <- function(model, postSeason){
  ...
  postSeason_mse <- mean(as.numeric(log.pred != postSeason$pass_attempt))
  return(postSeason_mse)
}
...
knn_mse <- function(model, postSeason){
  ...
  return(mean(knn.pred != postSeason$pass_attempt))
}
```